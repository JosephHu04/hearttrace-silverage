...
项目以国家卫健委 WS/T 888—2026 的多维老年综合评估思路为框架：每日心情打卡、PHQ-9/GAD-7/AD8 等标准化筛查与危机处置是三条独立链路。大模型只提取可追溯的候选信号和生成摘要，不能诊断、不能单独决定风险等级、不能关闭安全事件。详见 [筛查标准](docs/screening-standard.md)。
